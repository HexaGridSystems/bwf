  ...
  return (
    <section id="hero" className="relative h-screen max-h-[800px] overflow-hidden">
      ...
      >
        ...
        <h1 className="font-['Playfair_Display'] text-white text-4xl md:text-6xl font-bold mb-4">Bengaluru Wedding <br className="hidden sm:block" /> Fraternity <br /> Meet-up 3.0</h1>
        ...
        <div className="mt-12 md:mt-16 flex flex-col items-center">
          ...
          <CountdownTimer targetDate="July 15, 2025 09:00:00" />
        </div>
      </motion.div>
